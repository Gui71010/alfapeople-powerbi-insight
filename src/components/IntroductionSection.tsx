          ...
          <div className="flex flex-wrap justify-center items-center gap-4 mb-8">
            ...
            <div className="text-center">
              <a 
                ...
                className="inline-flex items-center bg-[#25D366] text-white px-6 py-3 text-base font-semibold rounded-lg no-underline shadow-lg transition-colors duration-300 hover:bg-[#1ebe57] gap-3"
              >
