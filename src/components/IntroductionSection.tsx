        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden p-6 mt-12">
            ...
            <a 
              ...
              className="block w-full bg-[#25D366] hover:bg-[#1ebe57] text-white text-center font-medium py-3 px-4 rounded-lg shadow-md transition-colors duration-300 mb-4"
            >
              Iniciar conversa
            </a>
